class GamePlay
{
	...
	initGameEnviroment() {
		...
		var drawBackground = () => {
			...
			if (!this.isStarted) {
				...
				this.gameContext.font = "italic bold 40px Arial";
				...
				this.gameContext.font = "italic bold 35px Arial";
				this.gameContext.fillStyle = "#F5DF0F";
				this.gameContext.fillText("START GAME",140,200);

				var highScore = 0;
				if (sessionStorage.getItem("highScore") != null) {
					highScore = sessionStorage.getItem("highScore");
				}
				this.gameContext.font = "italic 30px Arial";
				this.gameContext.fillStyle = "#FF0080";
				...
				this.menuContext.font = "italic bold 20px Arial";
				...
				this.menuContext.font = "50px Arial";
	...
	*/
	...
	/**
	* This below function is start, pause or stop
	*/
